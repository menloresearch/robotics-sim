...
export function setupGUI(parentContext) {
  ...
  parentContext.gui
    .add(parentContext.params, "scene", {
      ...
      G1: "g1_29dof_with_hand_rev_1_0.xml",
    })
    .name("Example Scene")
    .onChange(reload);
...
export async function downloadExampleScenesFolder(mujoco) {
  let allFiles = [
    ...
    "meshes/left_index_1.STL",
    "meshes/left_index_2.STL",
    "meshes/left_index_force_sensor_1.STL",
    "meshes/left_index_force_sensor_2.STL",
    "meshes/left_index_force_sensor_3.STL",
    "meshes/left_knee_link.STL",
    "meshes/left_little_1.STL",
    "meshes/left_little_2.STL",
    "meshes/left_little_force_sensor_1.STL",
    "meshes/left_little_force_sensor_2.STL",
    "meshes/left_little_force_sensor_3.STL",
    "meshes/left_middle_1.STL",
    "meshes/left_middle_2.STL",
    "meshes/left_middle_force_sensor_1.STL",
    "meshes/left_middle_force_sensor_2.STL",
    "meshes/left_middle_force_sensor_3.STL",
    "meshes/left_palm_force_sensor.STL",
    "meshes/left_ring_1.STL",
    "meshes/left_ring_2.STL",
    "meshes/left_ring_force_sensor_1.STL",
    "meshes/left_ring_force_sensor_2.STL",
    "meshes/left_ring_force_sensor_3.STL",
    ...
    "meshes/left_thumb_1.STL",
    "meshes/left_thumb_2.STL",
    "meshes/left_thumb_3.STL",
    "meshes/left_thumb_4.STL",
    "meshes/left_thumb_force_sensor_1.STL",
    "meshes/left_thumb_force_sensor_2.STL",
    "meshes/left_thumb_force_sensor_3.STL",
    "meshes/left_thumb_force_sensor_4.STL",
    "meshes/left_thumb_swing.STL",
    "meshes/left_wrist_pitch_link.STL",
    "meshes/left_wrist_roll_link.STL",
    "meshes/left_wrist_roll_rubber_hand.STL",
    "meshes/left_wrist_yaw_link.STL",
    "meshes/L_hand_base_link.STL",
    "meshes/Link11_L.STL",
    "meshes/Link11_R.STL",
    "meshes/Link12_L.STL",
    "meshes/Link12_R.STL",
    ...
    "meshes/right_index_1.STL",
    "meshes/right_index_2.STL",
    "meshes/right_index_force_sensor_1.STL",
    "meshes/right_index_force_sensor_2.STL",
    "meshes/right_index_force_sensor_3.STL",
    "meshes/right_knee_link.STL",
    "meshes/right_little_1.STL",
    "meshes/right_little_2.STL",
    "meshes/right_little_force_sensor_1.STL",
    "meshes/right_little_force_sensor_2.STL",
    "meshes/right_little_force_sensor_3.STL",
    "meshes/right_middle_1.STL",
    "meshes/right_middle_2.STL",
    "meshes/right_middle_force_sensor_1.STL",
    "meshes/right_middle_force_sensor_2.STL",
    "meshes/right_middle_force_sensor_3.STL",
    "meshes/right_palm_force_sensor.STL",
    "meshes/right_ring_1.STL",
    "meshes/right_ring_2.STL",
    "meshes/right_ring_force_sensor_1.STL",
    "meshes/right_ring_force_sensor_2.STL",
    "meshes/right_ring_force_sensor_3.STL",
    ...
    "meshes/right_thumb_1.STL",
    "meshes/right_thumb_2.STL",
    "meshes/right_thumb_3.STL",
    "meshes/right_thumb_4.STL",
    "meshes/right_thumb_force_sensor_1.STL",
    "meshes/right_thumb_force_sensor_2.STL",
    "meshes/right_thumb_force_sensor_3.STL",
    "meshes/right_thumb_force_sensor_4.STL",
    "meshes/right_wrist_pitch_link.STL",
    "meshes/right_wrist_roll_link.STL",
    "meshes/right_wrist_roll_rubber_hand.STL",
    "meshes/right_wrist_yaw_link.STL",
    "meshes/torso_constraint_L_link.STL",
    "meshes/torso_constraint_L_rod_link.STL",
    "meshes/torso_constraint_R_link.STL",
    "meshes/torso_constraint_R_rod_link.STL",
    "meshes/torso_link_23dof_rev_1_0.STL",
    "meshes/torso_link_rev_1_0.STL",
    "meshes/torso_link.STL",
    "meshes/waist_constraint_L.STL",
    "meshes/waist_constraint_R.STL",
    "meshes/waist_roll_link_rev_1_0.STL",
    "meshes/waist_roll_link.STL",
    "meshes/waist_support_link.STL",
    "meshes/waist_yaw_link_rev_1_0.STL",
    "meshes/waist_yaw_link.STL",
    "meshes/xl330_link.STL",
  ];
